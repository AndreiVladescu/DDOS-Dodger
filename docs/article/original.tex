...
\IEEEauthorblockA{\textit{Universitatea Națională de Știință și Tehnologie POLITEHNICA București}\\
Bucharest, Romania \\
andrei.vladescu2104@stud.acs.upb.ro}
\and
\IEEEauthorblockN{Ion Bica}
\IEEEauthorblockA{\textit{Academia Tehnică Militară "Ferdinand I"}\\
Bucharest, Romania \\
ion.bica@mta.ro
}
}
